      ...
      <div className="mt-3 rounded-xl border border-slate-700 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-3">
        <div className="credit-skin px-5 pb-6 pt-5">
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            <p className="text-xs uppercase tracking-[0.24em] text-[#d8b873]">{optionType} Node</p>
          </div>
          ...
          <div className="relative z-10 mt-4 flex items-end justify-between">
            ...
            <p className="text-xs uppercase tracking-[0.18em] text-[#d8b873]">{optionType}</p>
          </div>
        </div>
      </div>

      <div className={`mt-3 grid gap-2 text-xs grid-cols-2`}>
